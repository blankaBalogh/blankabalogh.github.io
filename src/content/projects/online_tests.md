...
The results presented in the following section are from my intern from last year. The preprint of his paper is available on [arxiv](https://arxiv.org/abs/2511.05074). 
...
Offline results: the straightforward NN achieved lower overall RMSE compared to the triggered architecture. If we had stopped there, we might have concluded it was the better model.
...
Once coupled online, this small bias, was amplified through physical interactions, especially in the upper troposphere and at high latitudes. After only a few simulated days, it led to significant overestimation of high cloud cover and large errors aloft.
