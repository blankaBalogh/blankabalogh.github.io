...
![Zonal mean moistening tendencies (1-year average). Left: "straightforward" NN, right: triggered NN.](src/content/figures/offline_rmse_G26.png)
...
![Bias between simulations using the "straightforward" NN (left column) or the triggered NN (right column), over a 5-year period, and a simulation with the emulated physical parameterization. Top row: high cloud cover, bottom row: outgoing longwave radiation (TOA OLR).](src/content/figures/online_bias.png)
...
![alt text](src/content/figures/gnn_sst.png)
