...
![Zonal mean moistening tendencies (1-year average). Left: "straightforward" NN, right: triggered NN.](public/images/figures/offline_rmse_G26.png)
...
![Bias between simulations using the "straightforward" NN (left column) or the triggered NN (right column), over a 5-year period, and a simulation with the emulated physical parameterization. Top row: high cloud cover, bottom row: outgoing longwave radiation (TOA OLR).](public/images/figures/online_bias.png)
